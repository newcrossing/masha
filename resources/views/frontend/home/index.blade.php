                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="text-center">
                            ...
                            <div class="mt-4 pt-2">
                                <a href="javascript:void(0)" class="btn btn-primary btn-hover">Started Now <i class="uil uil-rocket align-middle"></i></a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="blog-box card p-2 mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <a href="javascript:void(0)" class="form-text text-primary">Read more <i class="mdi mdi-chevron-right align-middle"></i></a>
                            </div>
                        </div><!--end blog-box-->
                    </div><!--end col-->
