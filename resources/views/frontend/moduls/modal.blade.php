                                    ...
                                    <label class="form-check-label" for="privacy_policy">
                                        ...
                                        <a href="{{route('contents',['s' => 'agreement'])}}" target="_blank"
                                           style=" text-decoration: #fffdfe  solid underline">Пользовательского
                                            соглашения</a>,
                                        условия
                                        <a href="{{route('contents',['s' => 'privacy-policy'])}}" target="_blank" style=" text-decoration: #fffdfe solid underline">Политики
                                            конфиденциальности</a>,
                                        условия
                                        <a href="{{route('contents',['s' => 'public-offer'])}}" target="_blank" style=" text-decoration: #fffdfe solid underline">Публичной
                                            оферты</a>,
